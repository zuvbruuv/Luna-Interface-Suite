...
function Luna:CreateWindow(WindowSettings)
    ...
    function Window:CreateTab(TabSettings)
        ...
        function Tab:BuildConfigSection()
            if isStudio then
                Tab:CreateLabel({Text = "Config system unavailable. (Environment isStudio)", Style = 1})
        ...
        function Luna:SaveConfig(Path)
            ...
            local fullPath = Luna.Folder .. "/settings/" .. Path .. ".json"
        ...
        function Luna:LoadConfig(Path)
            ...
            local file = Luna.Folder .. "/settings/" .. Path .. ".json"
